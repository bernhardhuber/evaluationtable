...
public interface BigIntegerConsumer {
    ...
    /**
     * Returns a composed {@code BigIntegerConsumer} that performs, in sequence,
     ...
     * @return a composed {@code BigIntegerConsumer} that performs in sequence
     * this operation followed by the {@code after} operation
     * @throws NullPointerException if {@code after} is null
     */
    default BigIntegerConsumer andThen(BigIntegerConsumer after) {

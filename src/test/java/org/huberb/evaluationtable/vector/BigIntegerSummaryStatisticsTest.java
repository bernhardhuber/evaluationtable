...
public class BigIntegerSummaryStatisticsTest {
    ...
    public BigIntegerSummaryStatisticsTest() {
    }
    ...
    public void testAccept() {
        ...
        BigIntegerSummaryStatistics instance = new BigIntegerSummaryStatistics();
    ...
    public void testToString() {
        ...
        assertEquals("BigIntegerSummaryStatistics{count=4, sum=12, min=0, average=3.000000, max=10}", result);
    }
    ...
    public void testForEachAccept() {
        ...
        BigInteger value1 = BigInteger.ONE;
        BigInteger value10 = BigInteger.TEN;
        List<BigInteger> bigDecimalList = Arrays.asList(value0, value1, value1, value10);
    ...
    public void testForEachAccept_neg_and_plus() {
        List<BigInteger> bigDecimalList = new ArrayList<>();
        for (int i = 0; i <= 99; i++) {
            bigDecimalList.add(BigInteger.valueOf(i));
            bigDecimalList.add(BigInteger.valueOf(-i));
        }
        ...
        assertEquals(BigInteger.valueOf(99), instance.getMax());
        assertEquals(BigInteger.valueOf(-99), instance.getMin());
        assertEquals(BigInteger.valueOf(0), instance.getSum());
    }
}
